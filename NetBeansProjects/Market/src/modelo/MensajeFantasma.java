 ...
 * class construction.
 */
public class MensajeFantasma extends JLabel implements FocusListener, DocumentListener {
    ...
    public MensajeFantasma(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public MensajeFantasma(String text, JTextComponent component, Show show) {
